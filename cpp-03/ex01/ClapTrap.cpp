...
/*   Updated: 2025/12/18 15:06:06 by gangel-a         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void ClapTrap::beRepaired(unsigned int amount){
	if (this->_hitPoints == 0) {
		std::cout << this->_name << " cannot be repaired anymore" << std::endl;
		return ;
	}
	else if (this->_energyPoints == 0) {
		std::cout << this->_name << " does not have any more energy points to use for repair" << std::endl;
		return ;
	}
	this->_hitPoints += amount;
	this->_energyPoints--;
	std::cout << this->_name << " spent 1 energy point to repair " << amount << "HP" << std::endl;
}
